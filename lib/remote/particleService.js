...
function getParticles(sprintId){
	logger.info("particleService.getParticles(%s)", sprintId);
...
function getParticlesCached(sprintId){
	return cache.wrapPromise("particleService.getParticles."+sprintId, _.partial(getParticles, sprintId));
}
